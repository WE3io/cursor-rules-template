...
## 3. Acceptance Checks
- [ ] `implementations/codex/AGENTS.md` exists with behavioral guidelines.
- [ ] `.codex/` structure created per Codex conventions.
- [ ] codex-translation checklist applied; intent preserved.
- [ ] Parity check run; canonical-tool-mapping.json updated for Codex.
